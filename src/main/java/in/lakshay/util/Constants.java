...
public final class Constants {
    ...
    public static final String THEATERS_PATH = API_V1 + "/theaters";
    public static final String SHOWTIMES_PATH = API_V1 + "/showtimes";
    public static final String SEATS_PATH = API_V1 + "/seats";
    public static final String RESERVATIONS_PATH = API_V1 + "/reservations";
